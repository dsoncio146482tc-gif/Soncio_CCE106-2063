          ...
          <>
            ...
            <View style={styles.heroCard}>
              <View style={styles.avatarWrapper}>
                <Image
                  source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsaUmHXlBhlV5d0vTMDrffsSyxxBeyTaud1JlW8QR3CaF0lBnmTX5UzQQ&s' }}
                  style={styles.avatar}
                />
              ...
              <View style={styles.profileTextContainer}>
                <Text style={styles.studentName}>Soncio, Daniel Dave V.</Text>
                <View style={styles.tagBadge}>
                  <Text style={styles.tagText}>3rd Year BSIT</Text>
                </View>
                <Text style={styles.studentEmail} numberOfLines={1}>
                  d.soncio.146482.tc@umindanao.edu.ph
                </Text>
              </View>
            </View>
